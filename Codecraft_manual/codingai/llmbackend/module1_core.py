...
def backend_to_frontend(backend_code: str):
    ...
    Uses Ollama (qwen2.5-coder) for generation.
    """
...
# ============================================================
# 🎨 UI to Frontend (Ollama-based)
# ============================================================

def ui_to_frontend(image_data: bytes, additional_context: str = "", include_typescript: bool = True, styling_approach: str = "tailwind"):
    """
    Generate React frontend from UI screenshot using Ollama models.
    Uses vision model for analysis and qwen2.5-coder for code generation.
    """
    from ui_to_frontend_ollama import ui_to_frontend_ollama
    return ui_to_frontend_ollama(image_data, additional_context, include_typescript, styling_approach)


def ui_to_frontend_multiple(image_data_list: list, additional_context: str = "", include_typescript: bool = True, styling_approach: str = "tailwind"):
    """
    Generate React frontend from multiple UI screenshots using Ollama models.
    """
    from ui_to_frontend_ollama import ui_to_frontend_ollama_multiple
    return ui_to_frontend_ollama_multiple(image_data_list, additional_context, include_typescript, styling_approach)
